...
UEFI Project example: https://mega.nz/file/ZwcETZxS#naOmrwfsAuACbLtE7hqbm5hs-5klcKAeKOa0qOPFvMc
...
Update: I was able to translate all the Python code to C++ for greater optimization, speed and the smallest possible size; it was a success, although there may be errors and bugs such as the error when trying to decrypt the MBR in Windows XP. The same cryptographic algorithms were used, adapted to C++ using Libsodium.
